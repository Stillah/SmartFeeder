...
from devices.weights import Weights, WeightsMock
from devices.cat_camera import CatDetectionCamera
...
if __name__ == "__main__":
    ...
    start_camera(user_id=args.user_id, display=args.display)
